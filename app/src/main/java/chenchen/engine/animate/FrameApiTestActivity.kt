...
import chenchen.engine.animate.demo.databinding.ActivityFrameApiTestBinding

/**
 * @author: chenchen
 * @since: 2024/5/28 15:37
 */
class FrameApiTestActivity : AppCompatActivity() {
    private val binding by lazy { ActivityFrameApiTestBinding.inflate(layoutInflater) }
